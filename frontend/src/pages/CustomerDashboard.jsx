                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {stores.map(s => (
                        <div
                            ...
                            className={`bg-neutral-900 border p-6 rounded-3xl flex items-center gap-6 cursor-pointer transition-all ${selectedStore?.retailer_id === s.retailer_id ? 'border-white border-2' : 'border-neutral-800 hover:bg-neutral-800'}`}
                        >
