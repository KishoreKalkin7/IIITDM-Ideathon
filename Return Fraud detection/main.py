...
app = FastAPI(
    title="Return Product Fraud Detection System",
    description="MVP Backend for detecting and preventing return fraud",
    version="1.0.0"
)
...
@app.post("/delivery-confirmation", response_model=DeliveryConfirmationResponse)
...
@app.post("/request-return", response_model=ReturnRequestResponse)
